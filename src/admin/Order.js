...
const Orders = () => {
    ...
    const showStatus = o => (
        <div className="form-group">
            <h3 className="mark mb-4"><strong>Status:</strong> {o.status}</h3>
            <select
                className="form-control"
    ...
    return (
        <Layout title="Orders" description={`Good day!!! ${user.name}, Manage your orders here !!!`}>
            <div className="row">
                        ...
                        return (
                            ...
                            >
                                ...
                                <ul className="list-group mb-2">
                                    ...
                                    <li className="list-group-item">
                                        <strong>Amount:</strong> Rs.{o.amount}
                                    </li>
                                    <li className="list-group-item">
